namespace X2J.Core.ReadXsd
{
    ...
    public static class ProcessRestrictions
    {
        ...
        public static void AddRestrictions(this JsonSchema schema, XmlSchemaSimpleTypeContent content,
        ...
        public static List<JToken> ProcessSimpleTypeRestriction(this XmlSchemaSimpleTypeRestriction restriction,
                                                                out bool pattern)
        {
            pattern = false;
